...
int main() {
    ...
    try {
        if (pasirinkimas == 1) {
            ...
            std::chrono::steady_clock::time_point programBegin;
            GeneruotiFailus(sugeneruoti_failai, studentu_kiekis, pazymiuKiekis, programBegin);
            Testinimas(studentai, sugeneruoti_failai, pazymiuKiekis, programBegin);
        } else {
